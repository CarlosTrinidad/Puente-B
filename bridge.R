bridge <- function() {
  # Construye un puente de (0,2) con puntos medios
  #
  # Returns:
  #   Un vector con los valores del puente ordenados 
...
# Parte 2
	...
	# Determina el valor de los indices que se usan para calcular la media de P(A)
		...
		#Buscamos el indice 1 y el indice 2 en argument para conocer la posicion de 
		#los dos valores en el vector val
			pos1 <- which( argument == indice1 , arr.ind = TRUE)
			pos2 <- which( argument == indice2 , arr.ind = TRUE)

		#Al conocer la posicion en la que se encuentran los dos indices,
		#se busca su respectivo P(A)
		#Este valor esta en la misma posicion del vector argument, 
		#por lo que no necesita ningun cambio
